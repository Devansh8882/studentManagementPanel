                            ...
                            for (lead in leads) {
                                ...
                                if(leads[lead].status != 3){
                                    printDataList += ` <tr>
                                                        ...
                                                        <td><button style="cursor:pointer" data-pid = "${leads[lead]._id}" id="process"><i class="fas fa-user-tie"></i></button></td>
                                                        <td><button style="cursor:pointer" data-pid = "${leads[lead]._id}" id="del"> <i class="fas fa-trash-alt"></i></button></td>
                            ...
                            for (lead in res.leads) {
                                ...
                                if(res.leads[lead].status != 3){
                                    printDataList += ` <tr>
                                                        ...
                                                        <td><button style="cursor:pointer" data-pid = "${res.leads[lead]._id}" id="process"><i class="fas fa-user-tie"></i></button></td>
                                                        <td><button style="cursor:pointer" data-pid = "${res.leads[lead]._id}" id="del"> <i class="fas fa-trash-alt"></i></button></td>
